...
export default function Booking() {
    ...
    return (
        <main className="w-[100%] flex flex-col items-center justify-center space-y-4 bg-signinbg min-h-screen" >
                <div className="fixed bg-registermenu rounded-md transition space-y-4 w-[25%]">
