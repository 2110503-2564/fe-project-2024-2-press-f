            ...
            {isAdd ? (
                <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex flex-row space-x-3">
                        <button
                            className="bg-purple-600 text-white px-6 py-2 rounded-lg shadow-md hover:bg-white hover:text-purple-500 border border-purple-500 transition"
                            onClick={handleAdd}
                            disabled={isLoading}
                        >
                        ...
                        <button
                            className="bg-purple-600 text-white px-6 py-2 rounded-lg shadow-md hover:bg-white hover:text-purple-600 border border-purple-600 transition"
                            onClick={(e) => {
                                setIsAdd(false);
                                e.stopPropagation();
                                e.preventDefault();
